...
beta = 25 * 10**(-5)   #5 * 10**(-5) #50 * 10**(-6) #25 * 10**(-4) #50 * 10**(-6) #25 * 10**(-5) #25*10**(-6) #0.001
alpha = 500 * 10**(-3) #500 * 10**(-3) # #167*10**(-3) #0.05
...
for i in range (1, n_steps + 1):
    ...
    X[1] = S
    X[2] = R
    dIdt = beta*S*I - alpha*I      # calculate the derivative dI/dt
    dSdt = -beta*S*I               # calculate the derivative dS/dt
    dRdt = alpha*I                 # calculate the derivative dR/dt
