...
library(perm)
rm(list = ls())
setwd("C:/courses/Edx/Current/MITx 14.310x Data Analysis for Social Scientists/Week8/")
...
print(sqrt(Vneyman))
print(actual_stat/sqrt(Vneyman)) # t-statistic

2*(1-pt(actual_stat/sqrt(Vneyman), df=nrow(schools)-1))
