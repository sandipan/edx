...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        height: an integer > 0
        """
        self.tiles = [[1 for x in xrange(height)] for x in xrange(width)] 
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return self.getNumTiles() - sum([sum(row) for row in self.tiles])        
        #raise NotImplementedError
    ...
    def getRandomPosition(self):
        ...
        """
        return Position(len(self.tiles)*random.random(), len(self.tiles[0])*random.random())
        #raise NotImplementedError
    ...
    def isPositionInRoom(self, pos):
        ...
        #return (x, y) >= (0, 0) and (x, y) < (len(self.tiles), len(self.tiles[0]))        
...
room.cleanTileAtPosition(Position(3, 5))
print room.isTileCleaned(3, 5)
print room.getNumCleanedTiles()
room.cleanTileAtPosition(Position(3, 5))
print room.isTileCleaned(3, 5)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for trial in range(num_trials):
        ...
        while room.getNumCleanedTiles() < min_coverage * room.getNumTiles():
            ...
            tick += 1
        ticks.append(tick)
    return (1.0 * sum(ticks)) / len(ticks)
    #raise NotImplementedError
...
#showPlot1("Robot Simulations", "#robots", "avg_time")
...
showPlot2("Robot Simulations", "aspect_ratios", "avg_time")
